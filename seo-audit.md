...
| International reach was limited to four locale routes | Medium | ClipDown exposes a much broader language footprint | Added 30 locale routes, native language selection, locale-aware metadata, reciprocal hreflang, RTL rendering, and sitemap entries; continue native-speaker review of supporting copy | Broader international discovery with synchronized technical signals | Implemented technically; editorial review ongoing |
